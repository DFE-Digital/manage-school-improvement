...
{
    /// <inheritdoc />
    public partial class addprogressreviewtable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProgressReview", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProgressReview_SupportProject_SupportProjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProgressReview_Id_SupportProjectId",
                schema: "RISE",
                table: "ProgressReview",
                columns: new[] { "Id", "SupportProjectId" });

            migrationBuilder.CreateIndex(
                name: "IX_ProgressReview_SupportProjectId",
                schema: "RISE",
                table: "ProgressReview",
