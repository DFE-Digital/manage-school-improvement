...
namespace Dfe.ManageSchoolImprovement.Infrastructure.Migrations
{
    ...
    [Migration("20260703121727_remove-remind-adviser-to-copy-in-RISE-field")]
    partial class removeremindadvisertocopyinRISEfield
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dfe.ManageSchoolImprovement.Domain.Entities.SupportProject.ProgressReview", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("Id", "SupportProjectId");

                    b.ToTable("ProgressReview", "RISE");

                    b.ToTable(tb => tb.IsTemporal(ttb =>
                            {
                                ttb.UseHistoryTable("ProgressReviewHistory", "RISE");
                                ttb
                                    .HasPeriodStart("PeriodStart")
                                    .HasColumnName("PeriodStart");
                                ttb
            ...
            modelBuilder.Entity("Dfe.ManageSchoolImprovement.Domain.Entities.SupportProject.SupportProject", b =>
                {
                    ...
                    b.Property<bool?>("AdviserCanBeSet")
                        .HasColumnType("bit");
                    ...
                    b.Property<int?>("CurrentDeliveryMilestone")
                        .HasColumnType("int");

                    b.Property<DateTime?>("DateAdviserAllocated")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("DateConflictOfInterestDeclarationChecked")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("DateDueDiligenceCompleted")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("DateEligibilityChanged")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTime?>("DatePreferredSupportOrganisationChosen")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("DateSupportIsDueToEnd")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<bool?>("InitialDeliveryOfficerAssigned")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("ProjectStatusChangedBy")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime?>("ProjectStatusChangedDate")
                        .HasColumnType("datetime2");

                    b.Property<string>("ProjectStatusChangedDetails")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<DateTime?>("ResponsibleBodyResponseToTheConflictOfInterestRequestReceivedDate")
                        .HasColumnType("datetime2");

                    b.Property<bool?>("ResponsibleBodyResponseToTheConflictOfInterestRequestSavedInSharePoint")
                        .HasColumnType("bit");

                    b.Property<bool?>("ReviewAdvisersConflictOfInterestForm")
                        .HasColumnType("bit");
                    ...
                    b.Property<int?>("SupportProjectEligibilityStatus")
                        .HasColumnType("int");

                    b.Property<string>("SupportingOrganisationAddress")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Dfe.ManageSchoolImprovement.Domain.Entities.SupportProject.SupportProjectContact", b =>
                {
                    ...
                    b.Property<string>("OrganisationTypeSubCategory")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("OrganisationTypeSubCategoryOther")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Dfe.ManageSchoolImprovement.Domain.Entities.SupportProject.Watchlist", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("User", "SupportProjectId");

                    b.ToTable("Watchlist", "RISE");

                    b.ToTable(tb => tb.IsTemporal(ttb =>
                            {
                                ttb.UseHistoryTable("WatchlistHistory", "RISE");
                                ttb
                                    .HasPeriodStart("PeriodStart")
                                    .HasColumnName("PeriodStart");
                                ttb
            ...
            modelBuilder.Entity("GovUK.Dfe.CoreLibs.ApplicationSettings.Entities.ApplicationSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ApplicationSettings", "RISE");
                });
