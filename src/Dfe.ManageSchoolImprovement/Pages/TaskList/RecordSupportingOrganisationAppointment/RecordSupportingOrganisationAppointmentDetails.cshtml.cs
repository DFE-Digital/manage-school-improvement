...
{
    public class RecordSupportingOrganisationAppointmentDetailsModel(ISupportProjectQueryService supportProjectQueryService, 
        ...
        IApplicationSettingsResourceService applicationSettingsResourceService) : BaseSupportProjectPageModel(supportProjectQueryService, errorService), IDateValidationMessageProvider
    {
        ...
        public async Task<IActionResult> OnPost(int id, CancellationToken cancellationToken)
        {
            ...
            var request = new SetRecordSupportingOrganisationAppointmentCommand(new SupportProjectId(id), RegionalDirectorAppointmentDate, SupportProject?.HasConfirmedSupportingOrganisationAppointment, SupportProject?.DisapprovingSupportingOrganisationAppointmentNotes);
