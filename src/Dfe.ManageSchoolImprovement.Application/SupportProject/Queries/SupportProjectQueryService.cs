...
namespace Dfe.ManageSchoolImprovement.Application.SupportProject.Queries
{
    public class SupportProjectQueryService(ISupportProjectRepository supportProjectRepository, IMapper mapper) : ISupportProjectQueryService
    {
        ...
        public async Task<Result<SupportProjectDto?>> GetBaseSupportProject(int id, CancellationToken cancellationToken)
        {
            var supportProjectId = new SupportProjectId(id);
            var supportProject = await supportProjectRepository.GetSupportProjectBaseById(supportProjectId, cancellationToken);
        ...
        public async Task<Result<SupportProjectDto?>> GetSupportProjectWithContacts(int id, CancellationToken cancellationToken)
        {
            var supportProjectId = new SupportProjectId(id);
            var supportProject = await supportProjectRepository.GetSupportProjectWithContactsById(supportProjectId, cancellationToken);
