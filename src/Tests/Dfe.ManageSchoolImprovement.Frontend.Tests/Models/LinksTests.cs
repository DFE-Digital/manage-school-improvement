...
namespace Dfe.ManageSchoolImprovement.Frontend.Tests.Models
{
    public class LinksTests
    {
        ...
        [InlineData("/TaskList/SendFormalNotification/Index")]
        ...
        [InlineData("/TaskList/AdviserMakeInitialContact/Index")]
        ...
        [InlineData("/TaskList/ChoosePreferredSupportingOrganisation/ChooseSupportingOrganisationType")]
