class TaskList {
  ...
  public hasNav(): this {
    ...
    //cy.contains("Improvement plan") //feature is behind the flag atm
  ...
  public hasTasks(): this {
   ...
   // cy.contains('Enter improvement plan objectives'); //feature is behind the flag atm
  ...
  public hasTasksNotStartedElementsPresent(): this {
   ...
   // cy.get("#enter-improvement-plan-objectives_status").contains('Not Started'); //feature is behind the flag atm
